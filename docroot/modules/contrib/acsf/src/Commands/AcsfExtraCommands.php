...
/**
 * This namespace is off but it is necessary. All the commands in this file are
 * executed with the --include flag, and without reusing this namespace the
 * commands would not be found.
 */
...
class AcsfExtraCommands extends DrushCommands {
   ...
   */
  public function completeAsyncProcess($options = ['data' => NULL]) {
